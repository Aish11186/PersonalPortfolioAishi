...
* **Fillit (The Autofill Extension)**: A lightweight Chrome browser extension built with **Plasmo** that autofills repetitive fields where the browser's native autofill doesn't reliably learn — especially LinkedIn, GitHub, portfolio links, and cold-email workflows. Supports trigger-based inline autocomplete (e.g. \`portfolio:\`, \`linkedin:\`, \`github:\`) so you can configure your details once and reuse them anywhere.
